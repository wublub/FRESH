...
DEFAULT_TEXTS = {
    ...
    '选择文件夹...': '选择文件夹...',
    '给当前截图添加文件...': '给当前截图添加文件...',
    '给当前截图添加文件夹...': '给当前截图添加文件夹...',
    '给这张截图添加文件或文件夹': '给这张截图添加文件或文件夹',
    '给这张截图添加文件或文件夹...': '给这张截图添加文件或文件夹...',
    '先选择截图': '先选择截图',
    '请先选中一张截图，再给这张截图添加文件或文件夹。': '请先选中一张截图，再给这张截图添加文件或文件夹。',
    '已添加到当前截图': '已添加到当前截图',
    '选择截图': '选择截图',
    '框选截图失败': '框选截图失败',
    '无法获取屏幕截图。': '无法获取屏幕截图。',
    ...
    '粘贴 (Ctrl+V)、拖入或添加文件/文件夹到此处': '粘贴 (Ctrl+V)、拖入或添加文件/文件夹到此处',
    '备注…': '备注…',
    '图片': '图片',
    '图片不存在': '图片不存在',
    '无法加载': '无法加载',
    ...
    '这段内容会保存到附件归档记录，并显示在时间线里。': '这段内容会保存到附件归档记录，并显示在时间线里。',
    '无法预览': '无法预览',
    '填写后点击“归档照片”。': '填写后点击“归档照片”。',
    '填写后点击“归档附件”。': '填写后点击“归档附件”。',
    '分类': '分类',
    '选择或输入分类': '选择或输入分类',
    '置顶': '置顶',
    '取消置顶': '取消置顶',
    ...
    '例如：整理完资料、确认这个文件的问题已经处理、记录文件夹里这批内容的状态...': '例如：整理完资料、确认这个文件的问题已经处理、记录文件夹里这批内容的状态...',
    '取消': '取消',
    '没有匹配的备忘录': '没有匹配的备忘录',
    ...
    '{count} 个归档附件': '{count} 个归档附件',
    '{count} 条归档备忘录': '{count} 条归档备忘录',
    '还没有归档内容\n\n归档照片或备忘录后会出现在这里': '还没有归档内容\n\n归档照片或备忘录后会出现在这里',
    '还没有归档内容\n\n归档附件或备忘录后会出现在这里': '还没有归档内容\n\n归档附件或备忘录后会出现在这里',
    '#{category} 下还没有归档内容': '#{category} 下还没有归档内容',
    '分类搜索“{category}” · ': '分类搜索“{category}” · ',
    '没有匹配“{category}”的分类内容': '没有匹配“{category}”的分类内容',
    '未知日期': '未知日期',
    '文件查找设置': '文件查找设置',
    ...
    '请填写归档分类。': '请填写归档分类。',
    '修改分类': '修改分类',
    '已修改分类为“{category}”': '已修改分类为“{category}”',
    '已清除分类': '已清除分类',
    '附件分类': '附件分类',
    '全部附件': '全部附件',
    '这个分类下没有附件': '这个分类下没有附件',
    '选择或输入附件分类:': '选择或输入附件分类:',
    '输入附件分类:': '输入附件分类:',
    '已修改附件分类为“{category}”': '已修改附件分类为“{category}”',
    '已清除附件分类': '已清除附件分类',
    '未找到': '未找到',
    ...
    '附件路径信息已刷新': '附件路径信息已刷新',
    '有附件路径失效，可在更多菜单手动查找': '有附件路径失效，可在更多菜单手动查找',
    '有附件路径变化，可在更多菜单手动查找': '有附件路径变化，可在更多菜单手动查找',
    '如文件已移动，可在更多菜单手动查找': '如文件已移动，可在更多菜单手动查找',
    '该附件已被移动或删除。可右键附件手动查找。': '该附件已被移动或删除。可右键附件手动查找。',
    '添加失败': '添加失败',
    '无法添加该附件。': '无法添加该附件。',
    '只能添加图片截图。': '只能添加图片截图。',
    '无法添加该文件或文件夹。': '无法添加该文件或文件夹。',
    '移除附件': '移除附件',
    '删除附件': '删除附件',
    ...
    '选择数据文件夹': '选择数据文件夹',
    '数据文件夹未改变': '数据文件夹未改变',
    '数据文件夹已切换到 {path}': '数据文件夹已切换到 {path}',
    '新的数据文件夹不能放在当前数据文件夹里面。': '新的数据文件夹不能放在当前数据文件夹里面。',
    '没有进入新数据文件夹，已保留当前数据文件夹。': '没有进入新数据文件夹，已保留当前数据文件夹。',
    '是否把当前数据复制到新的数据文件夹？\n\n当前：{current}\n新的：{new}': '是否把当前数据复制到新的数据文件夹？\n\n当前：{current}\n新的：{new}',
    '切换失败': '切换失败',
    '切换数据文件夹时出错:\n{error}': '切换数据文件夹时出错:\n{error}',
    '打开外观与文字配置': '打开外观与文字配置',
    '外观与文字配置...': '外观与文字配置...',
...
def apply_text_overrides(root=None):
    ...
    for widget in roots:
        # 这些覆盖大多由 Show 事件经 QTimer.singleShot(0) 延迟触发，等回调真正
        # 执行时控件可能已被销毁（如快速重建的列表/缩略图里的 QLabel），此时对
        # 已删除的底层 C++ 对象调用 findChildren 会抛 RuntimeError —— 跳过即可。
        try:
